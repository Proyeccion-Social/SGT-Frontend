// src/pages/api/sessions/reject-session.ts
// BFF: reads HttpOnly cookie, calls rejectSession

import type { APIRoute } from 'astro';
import { rejectSession } from '@features/emailScreens/services/sessionService';
